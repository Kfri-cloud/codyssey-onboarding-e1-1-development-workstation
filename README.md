...
이번 미션을 통해 개발 환경은 단순히 코드를 작성하는 공간이 아니라,

코드가 실행되고 관리되며 협업할 수 있도록 구성하는 시스템이라는 것을 배웠습니다.



처음에는 Terminal 명령어와 Docker 개념이 어렵게 느껴졌지만,

직접 명령어를 입력하고 환경을 구성하면서

개발자가 왜 자신의 작업 환경을 이해해야 하는지 알게 되었습니다.
